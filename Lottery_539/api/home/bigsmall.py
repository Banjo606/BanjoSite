...
def myStatistics(queryset, dict):
	for obj in queryset:
		dict[getBigSmall(obj.num_1)] += 1
		dict[getBigSmall(obj.num_2)] += 1
		dict[getBigSmall(obj.num_3)] += 1
		dict[getBigSmall(obj.num_4)] += 1
		dict[getBigSmall(obj.num_5)] += 1
